...
export const convertToCelsius = (tempInKelvin) =>
  (tempInKelvin - 273.15).toFixed(0);

// Converts the temperature to Fahrenheit
export const convertToFahrenheit = (tempInKelvin) =>
  (((tempInKelvin - 273.15) * 9) / 5 + 32).toFixed(0);
